/*
 * HalfMark as it behaves on /site-3, /site-4 and /new-construction — the
 * versions built locally. The shared `half-mark.tsx` was later reworked for `/`
 * and /site-1 (it leaves from the third section down and paints behind the page);
 * this copy keeps the original behaviour: it persists as a 10% watermark and
 * repaints over dark sections all the way down. Kept separate so neither set of
 * pages can change the other.
 */
"use client";
