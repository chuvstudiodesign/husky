...
import { Button } from "@/components/ui/button-v3";
    ...
    >
      <div className="section-x section-y-lg relative mx-auto max-w-7xl">
        ...
        <Reveal direction="up" delay={0.1} amount={0.2}>
          ...
          {/* The page's one scroll-linked passage. The reader lights the
              sentence as they read it, which paces the argument without
              breaking it into slides. Used once, deliberately. */}
          <div className="mt-10 flex max-w-[66ch] flex-col gap-6">
            <TextRevealScroll className="lead max-w-none text-[color:var(--navy-800)]">
          ...
          <div className="mt-12">
            <Button
              asChild
              size="lg"
              className="h-11 bg-[color:var(--navy-900)] px-8 text-white hover:bg-[color:var(--navy-800)] dark:bg-[color:var(--navy-900)] dark:hover:bg-[color:var(--navy-800)]"
            >
