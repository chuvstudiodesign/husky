            ...
            <div className="flex flex-wrap items-center gap-4">
              <Magnetic strength={0.2}>
                <Button
                  asChild
                  size="lg"
                  className="h-12 bg-[color:var(--brand-black)] px-8 text-[15px] text-white hover:bg-[color:var(--brand-black)]/85"
                >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-12 border-[color:var(--brand-black)]/35 bg-transparent px-8 text-[15px] text-[color:var(--brand-black)] hover:bg-[color:var(--brand-black)]/10 hover:text-[color:var(--brand-black)] dark:border-[color:var(--brand-black)]/35 dark:bg-transparent dark:hover:bg-[color:var(--brand-black)]/10"
              >
